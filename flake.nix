{
  ...
  outputs = { self, nixpkgs, disko, impermanence, home-manager, sops, duat-secrets, ... }@inputs:
    let
    ...
    in
    {
      ...
      nixosConfigurations = forEachHost (host:
        lib.nixosSystem {
          specialArgs = { inherit inputs lib disko sops home-manager impermanence duat-secrets; };
